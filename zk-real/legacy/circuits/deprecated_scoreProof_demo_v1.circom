// ============================================================
// ⚠️ LEGACY / DEPRECATED CIRCUIT
// ------------------------------------------------------------
// Este circuito está congelado y NO debe modificarse.
// NO usar como base del nuevo diseño.
// Solo referencia histórica.
// Sustituido por circuits/main/ en Fase 2.
// ============================================================
...
// ⚠️ DEPRECATED CIRCUIT
// This circuit is kept for reference only.
